                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      TextField(
                                        ...
                                        onChanged: (val) => newCardName = val,
                                      ),
                                      TextField(
                                        decoration: InputDecoration(labelText: 'Card Number'),
                                        onChanged: (val) => newCardNumber = val,
                                      ),
                                      TextField(
                                        decoration: InputDecoration(labelText: 'MM/YY'),
                                        onChanged: (val) => newCardMonthYear = val,
                                      ),
                                      ElevatedButton(
                                        child: Text('Add Card'),
                                        onPressed: () {
                                          if (newCardName != null && newCardNumber != null && newCardMonthYear != null && newCardName!.isNotEmpty && newCardNumber!.isNotEmpty && newCardMonthYear!.isNotEmpty) {
                                            setState(() {
                                              carArr.add({
                                                "name": newCardName,
                                                "number": newCardNumber,
                                                "month_year": newCardMonthYear
                                              });
                                            });
